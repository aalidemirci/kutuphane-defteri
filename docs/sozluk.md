...
*Aşağıdaki tablolar F9 sonundaki durumdur (25.09.2026); kaynak `AppShell.tsx`
...
satırlarda, **"İade her zaman açıktır."**; bağlantı **"Sayım'ı aç"**) · **Kişiler** ·
**Ayarlar** · **İlişik Listesi** ·
...
Mali yıl · Sayım kurulu · Başlangıç · Tamamlanma · Harcama yetkilisinin onayı; bölüm
...
üyeleri", "Mali yıl (isteğe bağlı)") · **Sayım Sırasındaki Seçenekler** (kutular **"TMY 32/3
